...
import 'sdr_detail_page_widget.dart' show SdrDetailPageWidget;
...
class SdrDetailPageModel extends FlutterFlowModel<SdrDetailPageWidget> {
  ...
  // Stores action output result for [Custom Action - flattenJsonChildrenOnly] action in Container widget.
  dynamic? flatJson;
  // Stores action output result for [Custom Action - storePdfDatabase] action in Button widget.
