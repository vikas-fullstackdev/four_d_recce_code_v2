...
import 'task_copy4_model.dart';
export 'task_copy4_model.dart';

class TaskCopy4Widget extends StatefulWidget {
  const TaskCopy4Widget({super.key});

  static String routeName = 'taskCopy4';
  static String routePath = '/taskCopy4';

  @override
  State<TaskCopy4Widget> createState() => _TaskCopy4WidgetState();
}

class _TaskCopy4WidgetState extends State<TaskCopy4Widget>
    with TickerProviderStateMixin {
  late TaskCopy4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaskCopy4Model());
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemBuilder:
                                          ...
                                          return TaskComponentWidget(
                                            key: Key(
                                                'Keyx6m_${taskVariableIndex}_of_${taskVariable.length}'),
