...
import '/index.dart';
import 'recce_template_working_widget.dart' show RecceTemplateWorkingWidget;
...
class RecceTemplateWorkingModel
    extends FlutterFlowModel<RecceTemplateWorkingWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in recceTemplateWorking widget.
  List<ReccetemplatesRow>? dynamicRecceTemaplteData;
  // Stores action output result for [Custom Action - syncHiveToSupabase] action in recceTemplateWorking widget.
  String? syncHoveToSupabaseOnSaveButton;
  // Stores action output result for [Custom Action - fetchAndFilterPages] action in recceTemplateWorking widget.
  List<String>? filterAndFetchPages;
  // Stores action output result for [Custom Action - getAllTruePageIndex] action in recceTemplateWorking widget.
  List<int>? getAllTruePageIndex;
  // Stores action output result for [Custom Action - getFirstPageIndex] action in recceTemplateWorking widget.
  int? getFirstPageInde;
  // Stores action output result for [Custom Action - getLastPageIndex] action in recceTemplateWorking widget.
