            ...
            child: Column(
              ...
              children: [
                ...
                FutureBuilder<List<UserRolesRow>>(
                  future: FFAppState().userIdInMessages(
                    uniqueQueryKey: 'userIdInMessages${currentUserUid}',
                      ...
                      child: Visibility(
                        ...
                        child: Padding(
                          ...
                          child: FutureBuilder<List<ProjectsRow>>(
                            future: FFAppState().messagesList(
                              uniqueQueryKey: 'messagesList${currentUserUid}',
                ...
                FutureBuilder<List<UserRolesRow>>(
                  future: FFAppState().userIdInMessagesContainer(
                    uniqueQueryKey:
                        'userIdInMessagesContainer${currentUserUid}',
                    requestFn: () => UserRolesTable().queryRows(
                      queryFn: (q) => q.eqOrNull(
                        'user_id',
                        currentUserUid,
                      ...
                      child: Visibility(
                        ...
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              26.0, 0.0, 26.0, 0.0),
                          child: FutureBuilder<List<ProjectsRow>>(
                            future: FFAppState().messageList2(
                              uniqueQueryKey: 'messageList2${currentUserUid}',
                              requestFn: () => ProjectsTable().queryRows(
                                queryFn: (q) => q,
                              ),
                            ),
