...
import 'add_store_model.dart';
export 'add_store_model.dart';
...
class AddStoreWidget extends StatefulWidget {
  ...
  static String routeName = 'addStore';
  static String routePath = '/addStore';

  @override
  State<AddStoreWidget> createState() => _AddStoreWidgetState();
}

class _AddStoreWidgetState extends State<AddStoreWidget> {
  late AddStoreModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddStoreModel());
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                                          ...
                                          if (selectedMedia != null &&
                                            ...
                                            try {
                                              ...
                                              ScaffoldMessenger.of(context)
                                                  .hideCurrentSnackBar();
                                              _model.isDataUploading_uploadDataUhn =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                ...
                                                downloadUrls.length ==
                                                    selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFiles_uploadDataUhn =
                                                    selectedUploadedFiles;
                                                _model.uploadedFileUrls_uploadDataUhn =
                                                    downloadUrls;
                                              });
                                              showUploadMessage(
                                                  context, 'Success!');
                              ...
                              if (_model.uploadedFileUrls_uploadDataUhn.length >
                                  0)
                                Builder(
                                  builder: (context) {
                                    final proposedLocation = _model
                                        .uploadedFileUrls_uploadDataUhn
                                        .map((e) => e)
                                        .toList();
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (selectedMedia != null &&
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_uploadDataEq2 =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                    selectedMedia.length &&
                                                downloadUrls.length ==
                                                    selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFiles_uploadDataEq2 =
                                                    selectedUploadedFiles;
                                                _model.uploadedFileUrls_uploadDataEq2 =
                                                    downloadUrls;
                                              });
                                            } else {
                                              safeSetState(() {});
                              ...
                              if (_model.uploadedFileUrls_uploadDataEq2.length >
                                  0)
                                Builder(
                                  builder: (context) {
                                    final locationPlan = _model
                                        .uploadedFileUrls_uploadDataEq2
                                        .map((e) => e)
                                        .toList();
