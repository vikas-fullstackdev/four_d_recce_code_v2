...
int getPreviousPageIndex(int currentIndex, List<String> visibleItems) {
  final allPages = [
    "int_a",
    "int_b",
    "int_c",
  ...
  if (trueIndexes.isEmpty) return currentIndex;

  int pos = trueIndexes.indexOf(currentIndex);

  if (pos == -1) {
    // If currentIndex not visible → default to first
