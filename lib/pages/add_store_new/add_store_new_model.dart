...
import '/index.dart';
import 'add_store_new_widget.dart' show AddStoreNewWidget;
import 'package:stop_watch_timer/stop_watch_timer.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class AddStoreNewModel extends FlutterFlowModel<AddStoreNewWidget> {
  ...
  bool isDataUploading_siteLocUploadDataUhn = false;
  List<FFUploadedFile> uploadedLocalFiles_siteLocUploadDataUhn = [];
  List<String> uploadedFileUrls_siteLocUploadDataUhn = [];

  bool isDataUploading_locationPlanUploadDataEq2A2 = false;
  List<FFUploadedFile> uploadedLocalFiles_locationPlanUploadDataEq2A2 = [];
  List<String> uploadedFileUrls_locationPlanUploadDataEq2A2 = [];
  ...
  bool isDataUploading_q21UploadData74bA3 = false;
  FFUploadedFile uploadedLocalFile_q21UploadData74bA3 =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_q21UploadData74bA3 = '';

  bool isDataUploading_q22UploadData74bA3 = false;
  List<FFUploadedFile> uploadedLocalFiles_q22UploadData74bA3 = [];
  List<String> uploadedFileUrls_q22UploadData74bA3 = [];

  bool isDataUploading_q23UploadData74bDif = false;
  List<FFUploadedFile> uploadedLocalFiles_q23UploadData74bDif = [];
  List<String> uploadedFileUrls_q23UploadData74bDif = [];
  ...
  bool isDataUploading_q41UploadData74bVis60 = false;
  List<FFUploadedFile> uploadedLocalFiles_q41UploadData74bVis60 = [];
  List<String> uploadedFileUrls_q41UploadData74bVis60 = [];

  bool isDataUploading_q42UploadData74bVis46 = false;
  List<FFUploadedFile> uploadedLocalFiles_q42UploadData74bVis46 = [];
  List<String> uploadedFileUrls_q42UploadData74bVis46 = [];

  bool isDataUploading_q43UploadData74bVisi4 = false;
  List<FFUploadedFile> uploadedLocalFiles_q43UploadData74bVisi4 = [];
  List<String> uploadedFileUrls_q43UploadData74bVisi4 = [];

  // State field(s) for q5Switch widget.
  bool? q5SwitchValue;
  bool isDataUploading_q51UploadData74bIsCor = false;
  List<FFUploadedFile> uploadedLocalFiles_q51UploadData74bIsCor = [];
  List<String> uploadedFileUrls_q51UploadData74bIsCor = [];
