...
import 'add_store_new_annoted_image_model.dart';
export 'add_store_new_annoted_image_model.dart';

class AddStoreNewAnnotedImageWidget extends StatefulWidget {
  const AddStoreNewAnnotedImageWidget({
    super.key,
    this.projectId,
  ...
  static String routeName = 'addStoreNewAnnotedImage';
  static String routePath = '/addStoreNewAnnotedImage';

  @override
  State<AddStoreNewAnnotedImageWidget> createState() =>
      _AddStoreNewAnnotedImageWidgetState();
}

class _AddStoreNewAnnotedImageWidgetState
    extends State<AddStoreNewAnnotedImageWidget> {
  late AddStoreNewAnnotedImageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddStoreNewAnnotedImageModel());
                      ...
                      child: Padding(
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              Text(
                                'Please Upload the Annotated Images',
                                style: FlutterFlowTheme.of(context)
                                    .bodyLarge
                                    .override(
                                      font: GoogleFonts.inter(
                                          ...
                                          if (selectedMedia != null &&
                                              selectedMedia.every((m) =>
                                                  validateFileFormat(
                                                      ...
                                                      context))) {
                                            safeSetState(() => _model
                                                    .isDataUploading_siteLocUploadDataA1 =
                                                true);
                                            ...
                                            try {
                                              ...
                                              ScaffoldMessenger.of(context)
                                                  .hideCurrentSnackBar();
                                              _model.isDataUploading_siteLocUploadDataA1 =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                ...
                                                downloadUrls.length ==
                                                    selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFiles_siteLocUploadDataA1 =
                                                    selectedUploadedFiles;
                                                _model.uploadedFileUrls_siteLocUploadDataA1 =
                                                    downloadUrls;
                                              });
                                              showUploadMessage(
                                                  context, 'Success!');
                              ...
                              Builder(
                                builder: (context) {
                                  final propoposedLocationImage = _model
                                      .uploadedFileUrls_siteLocUploadDataA1
                                      .toList();
                                  ...
                                  return SingleChildScrollView(
                                    ...
                                    child: Row(
                                      ...
                                      children: List.generate(
                                              propoposedLocationImage.length,
                                              (propoposedLocationImageIndex) {
                                        final propoposedLocationImageItem =
                                            propoposedLocationImage[
                                                propoposedLocationImageIndex];
                                        return ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(8.0),
                                          child: Image.network(
                                            propoposedLocationImageItem,
                                            width: 250.0,
                                            height: 200.0,
                                            fit: BoxFit.cover,
                                          ),
                                          ...
                                          if (selectedMedia != null &&
                                              selectedMedia.every((m) =>
                                                  validateFileFormat(
                                                      ...
                                                      context))) {
                                            safeSetState(() => _model
                                                    .isDataUploading_locationPlanUploadDataEq2 =
                                                true);
                                            var selectedUploadedFiles =
                                                <FFUploadedFile>[];
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_locationPlanUploadDataEq2 =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                    selectedMedia.length &&
                                                downloadUrls.length ==
                                                    selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFiles_locationPlanUploadDataEq2 =
                                                    selectedUploadedFiles;
                                                _model.uploadedFileUrls_locationPlanUploadDataEq2 =
                                                    downloadUrls;
                                              });
                                            } else {
                                              safeSetState(() {});
                              ...
                              Builder(
                                builder: (context) {
                                  final locationPlan = _model
                                      .uploadedFileUrls_locationPlanUploadDataEq2
                                      .toList();
                                          ...
                                          Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                    ...
                                                    if (selectedMedia != null &&
                                                        selectedMedia.every((m) =>
                                                            validateFileFormat(
                                                                ...
                                                                context))) {
                                                      safeSetState(() => _model
                                                              .isDataUploading_q21UploadData74b31 =
                                                          true);
                                                      var selectedUploadedFiles =
                                                          <FFUploadedFile>[];
                                                      ...
                                                      try {
                                                        ...
                                                        _model.isDataUploading_q21UploadData74b31 =
                                                            false;
                                                      }
                                                      if (selectedUploadedFiles
                                                          ...
                                                          downloadUrls.length ==
                                                              selectedMedia
                                                                  .length) {
                                                        safeSetState(() {
                                                          _model.uploadedLocalFiles_q21UploadData74b31 =
                                                              selectedUploadedFiles;
                                                          _model.uploadedFileUrls_q21UploadData74b31 =
                                                              downloadUrls;
                                                        });
                                                      } else {
                                                        safeSetState(() {});
                                                ...
                                                Builder(
                                                  builder: (context) {
                                                    final easyAccess = _model
                                                        .uploadedFileUrls_q21UploadData74b31
                                                        .toList();
                                                    ...
                                                    if (selectedMedia != null &&
                                                        selectedMedia.every((m) =>
                                                            validateFileFormat(
                                                                ...
                                                                context))) {
                                                      safeSetState(() => _model
                                                              .isDataUploading_q22UploadData74b32 =
                                                          true);
                                                      var selectedUploadedFiles =
                                                          <FFUploadedFile>[];
                                                      ...
                                                      try {
                                                        ...
                                                        _model.isDataUploading_q22UploadData74b32 =
                                                            false;
                                                      }
                                                      if (selectedUploadedFiles
                                                                  .length ==
                                                          ...
                                                          downloadUrls.length ==
                                                              selectedMedia
                                                                  .length) {
                                                        safeSetState(() {
                                                          _model.uploadedLocalFiles_q22UploadData74b32 =
                                                              selectedUploadedFiles;
                                                          _model.uploadedFileUrls_q22UploadData74b32 =
                                                              downloadUrls;
                                                        });
                                                      } else {
                                                        safeSetState(() {});
                                                ...
                                                Builder(
                                                  builder: (context) {
                                                    final moderateAccess = _model
                                                        .uploadedFileUrls_q22UploadData74b32
                                                        .toList();
                                                    ...
                                                    if (selectedMedia != null &&
                                                        selectedMedia.every((m) =>
                                                            validateFileFormat(
                                                                ...
                                                                context))) {
                                                      safeSetState(() => _model
                                                              .isDataUploading_q23UploadData74b33 =
                                                          true);
                                                      var selectedUploadedFiles =
                                                          <FFUploadedFile>[];
                                                      ...
                                                      try {
                                                        ...
                                                        _model.isDataUploading_q23UploadData74b33 =
                                                            false;
                                                      }
                                                      if (selectedUploadedFiles
                                                                  .length ==
                                                          ...
                                                          downloadUrls.length ==
                                                              selectedMedia
                                                                  .length) {
                                                        safeSetState(() {
                                                          _model.uploadedLocalFiles_q23UploadData74b33 =
                                                              selectedUploadedFiles;
                                                          _model.uploadedFileUrls_q23UploadData74b33 =
                                                              downloadUrls;
                                                        });
                                                      } else {
                                                        safeSetState(() {});
                                                ...
                                                Builder(
                                                  builder: (context) {
                                                    final difficultAccess = _model
                                                        .uploadedFileUrls_q23UploadData74b33
                                                        .toList();
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                FFButtonWidget(
                                                    ...
                                                    if (selectedMedia != null &&
                                                        selectedMedia.every((m) =>
                                                            validateFileFormat(
                                                                ...
                                                                context))) {
                                                      safeSetState(() => _model
                                                              .isDataUploading_q41UploadData74b41 =
                                                          true);
                                                      var selectedUploadedFiles =
                                                          <FFUploadedFile>[];
                                                      ...
                                                      try {
                                                        ...
                                                        _model.isDataUploading_q41UploadData74b41 =
                                                            false;
                                                      }
                                                      if (selectedUploadedFiles
                                                                  .length ==
                                                          ...
                                                          downloadUrls.length ==
                                                              selectedMedia
                                                                  .length) {
                                                        safeSetState(() {
                                                          _model.uploadedLocalFiles_q41UploadData74b41 =
                                                              selectedUploadedFiles;
                                                          _model.uploadedFileUrls_q41UploadData74b41 =
                                                              downloadUrls;
                                                        });
                                                      } else {
                                                        safeSetState(() {});
                                                  ...
                                                  text:
                                                      'Façade is visible more than 60%',
                                                  options: FFButtonOptions(
                                                    width: double.infinity,
                                                    height: 40.0,
                                                    padding:
                                                ...
                                                Builder(
                                                  builder: (context) {
                                                    final facadeVisible60Percentage =
                                                        _model
                                                            .uploadedFileUrls_q41UploadData74b41
                                                            .toList();
                                                    ...
                                                    return SingleChildScrollView(
                                                      ...
                                                      child: Row(
                                                        mainAxisSize:
                                                            MainAxisSize.max,
                                                        children: List.generate(
                                                            facadeVisible60Percentage
                                                                .length,
                                                            (facadeVisible60PercentageIndex) {
                                                          final facadeVisible60PercentageItem =
                                                              facadeVisible60Percentage[
                                                                  facadeVisible60PercentageIndex];
                                                          return Padding(
                                                            padding:
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                FFButtonWidget(
                                                    ...
                                                    if (selectedMedia != null &&
                                                        selectedMedia.every((m) =>
                                                            validateFileFormat(
                                                                ...
                                                                context))) {
                                                      safeSetState(() => _model
                                                              .isDataUploading_q42UploadData74b42 =
                                                          true);
                                                      var selectedUploadedFiles =
                                                          <FFUploadedFile>[];
                                                      ...
                                                      try {
                                                        ...
                                                        _model.isDataUploading_q42UploadData74b42 =
                                                            false;
                                                      }
                                                      if (selectedUploadedFiles
                                                                  .length ==
                                                          ...
                                                          downloadUrls.length ==
                                                              selectedMedia
                                                                  .length) {
                                                        safeSetState(() {
                                                          _model.uploadedLocalFiles_q42UploadData74b42 =
                                                              selectedUploadedFiles;
                                                          _model.uploadedFileUrls_q42UploadData74b42 =
                                                              downloadUrls;
                                                        });
                                                      } else {
                                                        safeSetState(() {});
                                                  ...
                                                  text:
                                                      'Façade is visible between 40- 60%',
                                                  options: FFButtonOptions(
                                                    width: double.infinity,
                                                    height: 40.0,
                                                    padding:
                                                ...
                                                Builder(
                                                  builder: (context) {
                                                    final facadeIsVisibleBetween40To60 =
                                                        _model
                                                            .uploadedFileUrls_q42UploadData74b42
                                                            .toList();
                                                    ...
                                                    return Row(
                                                      mainAxisSize:
                                                          MainAxisSize.max,
                                                      children: List.generate(
                                                          facadeIsVisibleBetween40To60
                                                              .length,
                                                          (facadeIsVisibleBetween40To60Index) {
                                                        final facadeIsVisibleBetween40To60Item =
                                                            facadeIsVisibleBetween40To60[
                                                                facadeIsVisibleBetween40To60Index];
                                                        return Padding(
                                                          padding:
                                                          ...
                                                          child: ClipRRect(
                                                            ...
                                                            child:
                                                                Image.network(
                                                              facadeIsVisibleBetween40To60Item,
                                                              width: 250.0,
                                                              height: 200.0,
                                                              fit: BoxFit.cover,
                                                            ),
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                FFButtonWidget(
                                                    ...
                                                    if (selectedMedia != null &&
                                                        selectedMedia.every((m) =>
                                                            validateFileFormat(
                                                                ...
                                                                context))) {
                                                      safeSetState(() => _model
                                                              .isDataUploading_q43UploadData74b42 =
                                                          true);
                                                      var selectedUploadedFiles =
                                                          <FFUploadedFile>[];
                                                      ...
                                                      try {
                                                        ...
                                                        _model.isDataUploading_q43UploadData74b42 =
                                                            false;
                                                      }
                                                      if (selectedUploadedFiles
                                                                  .length ==
                                                          ...
                                                          downloadUrls.length ==
                                                              selectedMedia
                                                                  .length) {
                                                        safeSetState(() {
                                                          _model.uploadedLocalFiles_q43UploadData74b42 =
                                                              selectedUploadedFiles;
                                                          _model.uploadedFileUrls_q43UploadData74b42 =
                                                              downloadUrls;
                                                        });
                                                      } else {
                                                        safeSetState(() {});
                                                  ...
                                                  text:
                                                      'Visibility of the façade is less than 40%',
                                                  options: FFButtonOptions(
                                                    width: double.infinity,
                                                    height: 40.0,
                                                    padding:
                                                ...
                                                Builder(
                                                  builder: (context) {
                                                    final visibilityFacade40 =
                                                        _model
                                                            .uploadedFileUrls_q43UploadData74b42
                                                            .toList();
                                                    ...
                                                    return SingleChildScrollView(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: List.generate(
                                                            visibilityFacade40
                                                                .length,
                                                            (visibilityFacade40Index) {
                                                          final visibilityFacade40Item =
                                                              visibilityFacade40[
                                                                  visibilityFacade40Index];
                                                          return Padding(
                                                            padding:
                                                      ...
                                                      if (selectedMedia !=
                                                          ...
                                                          selectedMedia.every((m) =>
                                                              validateFileFormat(
                                                                  ...
                                                                  context))) {
                                                        safeSetState(() => _model
                                                                .isDataUploading_q51UploadData74b5 =
                                                            true);
                                                        var selectedUploadedFiles =
                                                            <FFUploadedFile>[];
                                                        ...
                                                        try {
                                                          ...
                                                          _model.isDataUploading_q51UploadData74b5 =
                                                              false;
                                                        }
                                                        if (selectedUploadedFiles
                                                                    .length ==
                                                            ...
                                                            downloadUrls
                                                                ...
                                                                selectedMedia
                                                                    .length) {
                                                          safeSetState(() {
                                                            _model.uploadedLocalFiles_q51UploadData74b5 =
                                                                selectedUploadedFiles;
                                                            _model.uploadedFileUrls_q51UploadData74b5 =
                                                                downloadUrls;
                                                          });
                                                        } else {
                                                          safeSetState(() {});
                                                  ...
                                                  Builder(
                                                    builder: (context) {
                                                      final isItCornerShop = _model
                                                          .uploadedFileUrls_q51UploadData74b5
                                                          .toList();
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await ProjectsTable().update(
                            data: {
                              'annotated_images': <String, dynamic>{
                                'store_analysis_details': <String, dynamic>{
                                  ...
                                  'visibility_of_the_showroom_from_the_entrance':
                                    ...
                                    'façade_is_visible_between_40_60_percentage':
                                        _model
                                            .uploadedFileUrls_q42UploadData74b42,
                                    'façade_is_visible_40_percentage': _model
                                        .uploadedFileUrls_q43UploadData74b42,
                                  },
                                  'Is_it_a_corner_shop':
                                      <String, List<dynamic>?>{
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'Annotated Images added successfully',
                                style: TextStyle(
                                  color:
