                ...
                children: [
                            ...
                            children: [
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller: _model
                                        .projectnameTextFieldTextController,
                                    focusNode:
                                        _model.projectnameTextFieldFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText: 'Enter partner contact details',
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            font: GoogleFonts.inter(
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (selectedMedia != null &&
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_uploadData74b =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                ...
                                                downloadUrls.length ==
                                                    selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFile_uploadData74b =
                                                    selectedUploadedFiles.first;
                                                _model.uploadedFileUrl_uploadData74b =
                                                    downloadUrls.first;
                                              });
                                            } else {
                                              safeSetState(() {});
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          if (_model.projectnameTextFieldTextController.text !=
                              '') {
                            _model.projectsData = <String, dynamic>{
                              '\"pronjectName\"':
                                  '\"${_model.projectnameTextFieldTextController.text}\"',
                              '\"clientName\"':
                                  '\"${_model.clientNameTextFieldTextController.text}\"',
                            };
                            safeSetState(() {});
                            _model.addRecordToHive =
                                await actions.addRecordToHive(
                              'projects',
                              _model.projectsData!.toString(),
                            );
                            _model.projectsDataFromHive =
                                await actions.getRecordsFromHive(
                              'projects',
                            );
                            _model.projectInfoVar =
                                await ProjectsTable().insert({
                              'name': _model
                                  .projectnameTextFieldTextController.text,
                              'clientname':
                                  _model.clientNameTextFieldTextController.text,
                              'status': 'new',
                              'managerid': currentUserUid,
                              'createdat':
                                  supaSerialize<DateTime>(getCurrentTimestamp),
                              'addressOfSite': _model
                                  .addressOfSiteTextFieldTextController.text,
                              'clientLogo':
                                  _model.uploadedFileUrl_uploadData74b,
                              'clientPhone': _model
                                  .clientPhoneTextFieldTextController.text,
                              'clientContactDetails': _model
                                  .contactdetailsTextFieldTextController.text,
                              'partnerName': _model
                                  .partnerNameTextFieldTextController.text,
                              'partnerPhone': _model
                                  .partnerPhoneTextFieldTextController.text,
                              'partnerContactDetails': _model
                                  .partnerDetailsTextFieldTextController.text,
                              'projectCode': functions.getProjectCode(),
                              'project_type': widget!.projectType,
                            });
                            ...
                            FFAppState().clearProjectListCacheKey(
