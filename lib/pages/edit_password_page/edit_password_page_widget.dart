...
class EditPasswordPageWidget extends StatefulWidget {
  ...
  static String routeName = 'editPasswordPage';
  static String routePath = '/editPasswordPage';
            ...
            builder: (context, snapshot) {
              ...
              return Column(
                ...
                children: [
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  child: RichText(
                                    ...
                                    text: TextSpan(
                                      children: [
                                        TextSpan(
                                          text:
                                              'Enter your existing password and then the new email.',
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      focusNode:
                                          _model.oldpasswordTextFieldFocusNode,
                                      autofocus: false,
                                      obscureText: !_model
                                ...
                                if (_model.oldpasswordTextFieldTextController
                                        .text !=
                                    containerUsersRow?.password)
                                  Text(
                  ...
                  wrapWithModel(
                    model: _model.editPasswordModel,
                    updateCallback: () => safeSetState(() {}),
                    child: EditPasswordWidget(
                      parameter1: columnUsersRow!.password,
                    ),
                  ),
                ],
              );
