...
import 'qc2_component_model.dart';
export 'qc2_component_model.dart';

class Qc2ComponentWidget extends StatefulWidget {
  const Qc2ComponentWidget({
    super.key,
  ...
  @override
  State<Qc2ComponentWidget> createState() => _Qc2ComponentWidgetState();
}

class _Qc2ComponentWidgetState extends State<Qc2ComponentWidget> {
  late Qc2ComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Qc2ComponentModel());
