...
import 'task_component_admin_model.dart';
export 'task_component_admin_model.dart';

class TaskComponentAdminWidget extends StatefulWidget {
  const TaskComponentAdminWidget({
    super.key,
  ...
  @override
  State<TaskComponentAdminWidget> createState() =>
      _TaskComponentAdminWidgetState();
}

class _TaskComponentAdminWidgetState extends State<TaskComponentAdminWidget> {
  late TaskComponentAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaskComponentAdminModel());
                          ...
                          return Row(
                            ...
                            children: [
                              ...
                              Theme(
                                ...
                                child: Checkbox(
                                  value: _model
                                          .checkboxValueMap[taskNameVarItem] ??=
