...
import 'qc2_visit_form_model.dart';
export 'qc2_visit_form_model.dart';

class Qc2VisitFormWidget extends StatefulWidget {
  const Qc2VisitFormWidget({
    super.key,
  ...
  static String routeName = 'qc2VisitForm';
  static String routePath = '/qc2VisitForm';

  @override
  State<Qc2VisitFormWidget> createState() => _Qc2VisitFormWidgetState();
}

class _Qc2VisitFormWidgetState extends State<Qc2VisitFormWidget>
    with TickerProviderStateMixin {
  late Qc2VisitFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Qc2VisitFormModel());
                ...
                children: [
                  ...
                  FutureBuilder<List<ReccetemplatesRow>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<ReccetemplatesRow> listViewReccetemplatesRowList =
                          snapshot.data!;
                          ...
                          return ListView.separated(
                            ...
                            itemBuilder: (context, qcFormListIndex) {
                              ...
                              return QcFormComponentWidget(
                                key: Key(
                                    'Keypzg_${qcFormListIndex}_of_${qcFormList.length}'),
