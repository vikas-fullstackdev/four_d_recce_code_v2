...
import 'store_detail_page_model.dart';
export 'store_detail_page_model.dart';

class StoreDetailPageWidget extends StatefulWidget {
  const StoreDetailPageWidget({
    super.key,
    this.projectId,
    this.projectName,
    this.proectImage,
  ...
  static String routePath = '/storeDetailPage';

  @override
  State<StoreDetailPageWidget> createState() => _StoreDetailPageWidgetState();
}

class _StoreDetailPageWidgetState extends State<StoreDetailPageWidget>
    with TickerProviderStateMixin {
  late StoreDetailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StoreDetailPageModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ReccetemplatesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ReccetemplatesRow> storeDetailPageReccetemplatesRowList =
            snapshot.data!;

        final storeDetailPageReccetemplatesRow =
            storeDetailPageReccetemplatesRowList.isNotEmpty
                ? storeDetailPageReccetemplatesRowList.first
                : null;
                                    ...
                                    children: [
                                      ...
                                      Align(
                                        ...
                                        child: FlutterFlowTimer(
                                          key: ValueKey('storeDetailPageTimer'),
                                          initialTime:
                                                    ...
                                                    child: Builder(
                                                      builder: (context) {
                                                        final proposedPlan =
                                                          ...
                                                          columnProjectsRow
                                                              ?.store,
                                                          r'''$.proposedLocation.proposedLocation''',
                                                        ).toList();
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(30.0, 0.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Is it a corner shop : ${getJsonField(
                                                        columnProjectsRow
                                                            ?.storeAnalysis,
                                                        r'''$.store_analysis_details.Is_it_a_corner_shop.is_it_a_corner_shop''',
                                                      ).toString()}',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Builder(
                                                      builder: (context) {
                                                        final isItCornerShop =
                                                            getJsonField(
                                                          columnProjectsRow
                                                              ?.storeAnalysis,
                                                          r'''$.store_analysis_details.Is_it_a_corner_shop.if_yes_then_image''',
                                                        ).toList();
                                                            ...
                                                            children: List.generate(
                                                              ...
                                                              return InkWell(
                                                                ...
                                                                onDoubleTap:
                                                                  ...
                                                                  await downloadFile(
                                                                    filename:
                                                                        'It is a Corner shop images',
                                                                    url: isItCornerShopItem
                                                                        .toString(),
                                                                  );
                                                                },
                                                                child:
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(30.0, 0.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Neighboring Outlets : ${getJsonField(
                                                        columnProjectsRow
                                                            ?.storeAnalysis,
                                                        r'''$.store_analysis_details.neighboring_outlets''',
                                                      ).toString()}',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(30.0, 0.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Socio Economic Classification : ${getJsonField(
                                                        columnProjectsRow
                                                            ?.storeAnalysis,
                                                        r'''$.store_analysis_details.socio_economic_classification''',
                                                      ).toString()}',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(30.0, 0.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Access to Store From Front : Easy Access',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .titleSmall
                                                    ...
                                                    child: Builder(
                                                      builder: (context) {
                                                        final easyAccess =
                                                          ...
                                                          columnProjectsRow
                                                              ?.storeAnalysis,
                                                          r'''$.store_analysis_details.access_to_the_store_from_the_front.easy_acces''',
                                                        ).toList();
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(30.0, 0.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Access to Store From Front : Moderate Access',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .titleSmall
                                                    ...
                                                    child: Builder(
                                                      builder: (context) {
                                                        final moderate =
                                                          ...
                                                          columnProjectsRow
                                                              ?.storeAnalysis,
                                                          r'''$.store_analysis_details.access_to_the_store_from_the_front.moderate_access''',
                                                        ).toList();
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(30.0, 0.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Access to Store From Front : Difficult Access',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .titleSmall
                                                    ...
                                                    child: Builder(
                                                      builder: (context) {
                                                        final dificult =
                                                          ...
                                                          columnProjectsRow
                                                              ?.storeAnalysis,
                                                          r'''$.store_analysis_details.access_to_the_store_from_the_front.difficult_access''',
                                                        ).toList();
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(30.0, 0.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Visibiliy of the showrom from Font-End',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .titleSmall
                                                    ...
                                                    child: Builder(
                                                      builder: (context) {
                                                        final facade40 =
                                                          ...
                                                          columnProjectsRow
                                                              ?.storeAnalysis,
                                                          r'''$.store_analysis_details.visibility_of_the_showroom_from_the_entrance.façade_is_visible_40_percentage''',
                                                        ).toList();
                                                            ...
                                                            children: List.generate(
                                                              ...
                                                              return InkWell(
                                                                ...
                                                                onDoubleTap:
                                                                  ...
                                                                  await downloadFile(
                                                                    filename:
                                                                        'visibility_of_the_showroom_from_the_entrance.façade_is_visible_40_percentage',
                                                                    url: facade40Item
                                                                        .toString(),
                                                                  );
                                                                },
                                                    ...
                                                    child: Builder(
                                                      builder: (context) {
                                                        final facade60 =
                                                          ...
                                                          columnProjectsRow
                                                              ?.storeAnalysis,
                                                          r'''$.store_analysis_details.visibility_of_the_showroom_from_the_entrance.façade_is_visible_more_than_60_percentage''',
                                                        ).toList();
                                                            ...
                                                            children: List.generate(
                                                              ...
                                                              return InkWell(
                                                                ...
                                                                onDoubleTap:
                                                                  ...
                                                                  await downloadFile(
                                                                    filename:
                                                                        'visibility_of_the_showroom_from_the_entrance.façade_is_visible_more_than_60_percentage',
                                                                    url: facade60Item
                                                                        .toString(),
                                                                  );
                                                                },
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(30.0, 0.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'façade_is_visible_between_40%_60%',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .titleSmall
                                                    ...
                                                    child: Builder(
                                                      builder: (context) {
                                                        final facade40To60 =
                                                          ...
                                                          columnProjectsRow
                                                              ?.storeAnalysis,
                                                          r'''$.store_analysis_details.visibility_of_the_showroom_from_the_entrance.façade_is_visible_between_40_60_percentage''',
                                                        ).toList();
                                                            ...
                                                            children: List.generate(
                                                              ...
                                                              return InkWell(
                                                                ...
                                                                onDoubleTap:
                                                                  ...
                                                                  await downloadFile(
                                                                    filename:
                                                                        'visibility_of_the_showroom_from_the_entrance.façade_is_visible_between_40_60_percentage',
                                                                    url: facade40To60Item
                                                                        .toString(),
                                                                  );
                                                                },
                                                                child:
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return Column(
                                            ...
                                            children: [
                                              ...
                                              if (storeDetailPageReccetemplatesRow
                                                      ?.projectid !=
                                                  widget!.projectId)
                                                Align(
                                                  alignment:
                                                      ...
                                                      onPressed: () async {
                                                        context.goNamed(
                                                          ...
                                                          queryParameters: {
                                                            'projectID':
                                                                serializeParam(
                                                              storeDetailPageReccetemplatesRow
                                                                  ?.projectid,
                                                              ParamType.String,
                                                            ),
                                                          }.withoutNulls,
