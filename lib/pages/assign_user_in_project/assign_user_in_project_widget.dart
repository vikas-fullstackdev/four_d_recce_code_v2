...
import 'assign_user_in_project_model.dart';
export 'assign_user_in_project_model.dart';

class AssignUserInProjectWidget extends StatefulWidget {
  const AssignUserInProjectWidget({
    super.key,
  ...
  static String routeName = 'assignUserInProject';
  static String routePath = '/assignUserInProject';

  @override
  State<AssignUserInProjectWidget> createState() =>
      _AssignUserInProjectWidgetState();
}

class _AssignUserInProjectWidgetState extends State<AssignUserInProjectWidget>
    with TickerProviderStateMixin {
  late AssignUserInProjectModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AssignUserInProjectModel());
