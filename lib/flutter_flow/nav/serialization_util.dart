    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case ProjectsUsersRow:
            return ProjectsUsersRow(data);
          case RecceresponsesRow:
            return RecceresponsesRow(data);
          case ReccestagesRow:
            return ReccestagesRow(data);
          case StoreRow:
          ...
          case ReccetemplatesRow:
            return ReccetemplatesRow(data);
          case UserRolesRow:
