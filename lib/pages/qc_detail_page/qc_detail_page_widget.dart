...
import 'qc_detail_page_model.dart';
export 'qc_detail_page_model.dart';

class QcDetailPageWidget extends StatefulWidget {
  const QcDetailPageWidget({
    super.key,
    this.projectId,
    this.projectName,
    this.proectImage,
  ...
  static String routeName = 'qcDetailPage';
  static String routePath = '/qcDetailPage';

  @override
  State<QcDetailPageWidget> createState() => _QcDetailPageWidgetState();
}

class _QcDetailPageWidgetState extends State<QcDetailPageWidget>
    with TickerProviderStateMixin {
  late QcDetailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QcDetailPageModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ReccetemplatesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ReccetemplatesRow> qcDetailPageReccetemplatesRowList =
            snapshot.data!;

        final qcDetailPageReccetemplatesRow =
            qcDetailPageReccetemplatesRowList.isNotEmpty
                ? qcDetailPageReccetemplatesRowList.first
                : null;
                                    ...
                                    children: [
                                      ...
                                      Align(
                                        ...
                                        child: FlutterFlowTimer(
                                          key: ValueKey('qcDetailPageTimer'),
                                          initialTime:
                              ...
                              child: FutureBuilder<List<ReccestagesRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return FFButtonWidget(
                                    ...
                                    text: 'Fill Client QC Visit Form',
                                    icon: Icon(
                                      Icons.mode_edit_rounded,
                                      size: 24.0,
                                    ),
                                ...
                                child: RichText(
                                  ...
                                  text: TextSpan(
                                    children: [
                                      ...
                                      TextSpan(
                                        text:
                                            '1. Select \"Make QC\" to create a new QC form.\n\n2. Select \"Fill QC Form\" to complete a QC form that was previously created for this project.\n\n3. Select \"Make Client QC\" to create a QC form in collaboration with the client.\n\n4. Select \"Fill Client QC Form\" to complete a Client QC form that was previously created for this project.\n',
                                        style: TextStyle(),
                                      )
                                    ],
                                    style: FlutterFlowTheme.of(context)
