...
import 'rece_template_working_widget.dart' show ReceTemplateWorkingWidget;
...
class ReceTemplateWorkingModel
    extends FlutterFlowModel<ReceTemplateWorkingWidget> {
  ...
  dynamic localOfflineStateWorking;

  ///  State fields for stateful widgets in this page.

  final formKey = GlobalKey<FormState>();
  // Stores action output result for [Backend Call - Query Rows] action in receTemplateWorking widget.
  List<ReccetemplatesRow>? dynamicRecceTemaplteData;
  // Stores action output result for [Custom Action - syncHiveToSupabase] action in receTemplateWorking widget.
  String? syncHoveToSupabaseOnSaveButton;
  // Stores action output result for [Custom Action - fetchAndFilterPages] action in receTemplateWorking widget.
  List<String>? filterAndFetchPages;
  // Stores action output result for [Custom Action - getAllTruePageIndex] action in receTemplateWorking widget.
  List<int>? getAllTruePageIndex;
  // Stores action output result for [Custom Action - getFirstPageIndex] action in receTemplateWorking widget.
  int? getFirstPageInde;
  // Stores action output result for [Custom Action - getLastPageIndex] action in receTemplateWorking widget.
