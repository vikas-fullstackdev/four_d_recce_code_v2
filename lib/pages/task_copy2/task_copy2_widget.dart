...
import 'task_copy2_model.dart';
export 'task_copy2_model.dart';

class TaskCopy2Widget extends StatefulWidget {
  const TaskCopy2Widget({super.key});

  static String routeName = 'taskCopy2';
  static String routePath = '/taskcopy2';

  @override
  State<TaskCopy2Widget> createState() => _TaskCopy2WidgetState();
}

class _TaskCopy2WidgetState extends State<TaskCopy2Widget>
    with TickerProviderStateMixin {
  late TaskCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaskCopy2Model());
                                      ...
                                      return ListView.separated(
                                        ...
                                        itemBuilder:
                                          ...
                                          return TaskComponentWidget(
                                            key: Key(
                                                'Keymgj_${taskVariableIndex}_of_${taskVariable.length}'),
